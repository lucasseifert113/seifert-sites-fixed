...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/local-seo`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/google-ads`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/social-media-management`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/website-audits`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
